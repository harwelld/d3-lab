...
window.onload = function(){
    ...
    var container = d3.select("#map") //get the <body> element from the DOM
    ...
    var innerRect = container.append("rect")
        ...
        .attr("width", function(d){ //rectangle width - d is data value
    ...
    var circles = container.selectAll(".circles") //but wait--there are no circles yet!
        .data(cityPop) //pass in data array
        .enter() //data join method
        .append("circle") //creates circle element for each data value in array
